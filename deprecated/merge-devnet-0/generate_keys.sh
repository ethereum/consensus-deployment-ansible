...
prep_group 1 "$VALIDATORS_MNEMONIC_0" 0 15 "merge-devnet-0-lighthouse-geth"

echo "Lighthouse keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 15 1 "merge-devnet-0-lighthouse-nethermind"

echo "Lighthouse keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 16 1 "merge-devnet-0-lodestar-geth"

echo "Lodestar keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 17 1 "merge-devnet-0-lodestar-nethermind"

echo "Lodestar keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 18 1 "merge-devnet-0-nimbus-geth"

echo "Lodestar keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 19 1 "merge-devnet-0-prysm-geth"
