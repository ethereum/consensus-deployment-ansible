...
echo "teku keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 0 3 "goerli-shadow-fork-4-teku-geth" 1000

echo "lighthouse keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 3 4 "goerli-shadow-fork-4-lighthouse-geth" 1000

echo "prysm keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 7 13 "goerli-shadow-fork-4-prysm-geth" 1000

echo "teku keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 40 1 "goerli-shadow-fork-4-teku-nethermind" 500

echo "teku keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 41 1 "goerli-shadow-fork-4-prysm-erigon" 500
...
echo "lodestar keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 45 1 "goerli-shadow-fork-4-lodestar-nethermind" 500

echo "nimbus keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 46 1 "goerli-shadow-fork-4-nimbus-geth" 500

echo "nimbus keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 47 1 "goerli-shadow-fork-4-nimbus-nethermind" 500

echo "prysm keys"
prep_group 1 "$VALIDATORS_MNEMONIC_0" 24 1 "goerli-shadow-fork-4-prysm-nethermind" 1000